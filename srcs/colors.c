...
/*   Updated: 2025/03/05 21:01:05 by rafaelfe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	gradient(int startcolor, int endcolor, double len, int pix)
{
	...
	color.step_r = ((get_r(endcolor)) - (get_r(startcolor))) / len;
	color.step_g = ((get_g(endcolor)) - (get_g(startcolor))) / len;
	color.step_b = ((get_b(endcolor)) - (get_b(startcolor))) / len;
